...
export const http = defineConfig({
  ...
  /**
   * keepAliveTimeout should exceed your reverse proxy's proxy_read_timeout
   * to prevent 502 errors from premature connection closure.
   * Default Node.js is 5s; Nginx default proxy_read_timeout is 60s.
   */
